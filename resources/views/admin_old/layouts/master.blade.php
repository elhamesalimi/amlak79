...
<div id="wrapper">
    ...
    <div class="topbar">
        ...
        <div class="topbar-left">
            <a href="index.html" class="logo"><span>آقای<span>توکلی</span></span><i class="zmdi zmdi-layers"></i></a>
        </div>
        ...
        <div class="sidebar-inner slimscrollleft">
            ...
            <div id="sidebar-menu">
                <ul>
                    ...
                    <li>
                        <a href={{ action('Admin\EstateController@index') }} class="waves-effect"><i class="zmdi zmdi-format-underlined"></i> <span> ملک ها </span> </a>
                    </li>
