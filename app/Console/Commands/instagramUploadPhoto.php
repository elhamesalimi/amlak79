...
class instagramUploadPhoto extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'instagram:upload';
     ...
     * @var string
     */
    protected $description = 'upload estate photo in instagram';
...
/////// CONFIG ///////
        ...
        $password = config('services.instagram.PASSWORD');
        $debug = true;
        $truncatedDebug = false;
//////////////////////
/////// MEDIA ////////
        $photoFilename = public_path('/public_data/images/thumbs600x450/2a1cFSrTD4F37KsK47POd8a8t.jpg');
        $captionText = "خرید آپارتمان در #قزوین";
//////////////////////
