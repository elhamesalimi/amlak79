...
!function (a) {
    ...
    a.extend(a.fn, {
        ...
        messages: {
            ...
            dateISO: "لطفا تاریخ معتبر (ISO) را وارد کنید.",
            number: "لطفا یک شماره تلفن معتبر وارد کنید.",
            digits: "لطفا فقط رقم را وارد کنید.",
            equalTo: "لطفا مجددا همان مقدار را وارد کنید.",
            maxlength: a.validator.format("لطفا حداکثر {0} نویسه را وارد کنید."),
            minlength: a.validator.format("لطفا حداقل {0} نویسه را وارد کنید."),
            rangelength: a.validator.format("لطفا یک مقدار بین {0} و {1} حرف طولانی وارد کنید."),
            range: a.validator.format("لطفا یک مقدار بین {0} و {1} را وارد کنید."),
            max: a.validator.format("لطفا یک مقدار کمتر یا برابر {0} را وارد کنید."),
            min: a.validator.format("لطفا یک مقدار بزرگتر یا برابر {0} را وارد کنید."),
            step: a.validator.format("لطفا چندین از {0} را وارد کنید.")
        },
        autoCreateRanges: !1,
        prototype: {
            init: function () {
